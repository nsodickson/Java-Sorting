...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        if (isSorted(test)) {
            System.out.println("Bubble sort took " + (end - start) / 1000 + " seconds to run with " + swaps + " swaps");
        } else {
        ...
        if (isSorted(test)) {
            System.out.println("Cocktail Shaker sort took " + (end - start) / 1000 + " seconds to run with " + swaps + " swaps");
        } else {
        ...
        if (isSorted(test)) {
            System.out.println("Gnome sort took " + (end - start) / 1000 + " seconds to run with " + swaps + " swaps");
        } else {
        ...
        if (isSorted(test)) {
            System.out.println("Selection sort took " + (end - start) / 1000 + " seconds to run with " + swaps + " swaps");
        } else {
        ...
        if (isSorted(test)) {
            System.out.println("Insertion sort took " + (end - start) / 1000 + " seconds to run with " + swaps + " swaps");
        } else {
        ...
        if (isSorted(test)) {
            System.out.println("Merge sort took " + (end - start) / 1000 + " seconds to run with " + swaps + " swaps");
        } else {
        ...
        if (isSorted(test)) {
            System.out.println("Quick sort took " + (end - start) / 1000 + " seconds to run with " + swaps + " swaps");
        } else {
        ...
        if (isSorted(test)) {
            System.out.println("Radix sort (LSD) took " + (end - start) / 1000 + " seconds to run with " + swaps + " swaps");
        } else {
        ...
        if (isSorted(test)) {
            System.out.println("Radix sort (MSD) took " + (end - start) / 1000 + " seconds to run with " + swaps + " swaps");
        } else {
        ...
        if (isSorted(test)) {
            System.out.println("Heap sort took " + (end - start) / 1000 + " seconds to run with " + swaps + " swaps");
        } else {
        ...
        if (isSorted(test)) {
            System.out.println("Counting sort took " + (end - start) / 1000 + " seconds to run with " + swaps + " swaps");
        } else {
